...
{
    [HarmonyPatch]
    public static class RoadBaseAIUpdateLanesPatch
    {
        public static MethodBase TargetMethod()
        {
            return typeof(RoadBaseAI).GetMethod("UpdateLanes");
        }
        ...
        public static void Postfix(ref NetSegment data)
        {
            ...
            if (CSURUtil.IsCSURLaneOffset(m_info))
            {
                ...
                bool flag7 = false;
                if (data.m_averageLength < 11f && (instance.m_nodes.m_buffer[data.m_startNode].m_flags & NetNode.Flags.Junction) != 0 && (instance.m_nodes.m_buffer[data.m_endNode].m_flags & NetNode.Flags.Junction) != 0)
                {
                    flag7 = true;
                }
                firstLane = data.m_lanes;
